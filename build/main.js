...
/******/ 		return __webpack_require__.p + "" + ({"news":"news","error":"error"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ \"./src/js/constants.js\");\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n// Creational Pattern\n// Factory\n\n\nvar Factory =\n/*#__PURE__*/\nfunction () {\n  function Factory() {\n    _classCallCheck(this, Factory);\n  }\n\n  _createClass(Factory, [{\n    key: \"create\",\n    value: function create(channel) {\n      var request = new Request(channel);\n      request.fetch();\n    }\n  }]);\n\n  return Factory;\n}();\n\nvar Request =\n/*#__PURE__*/\nfunction () {\n  function Request(channel) {\n    _classCallCheck(this, Request);\n\n    this.channel = channel;\n  }\n\n  _createClass(Request, [{\n    key: \"fetch\",\n    value: function (_fetch) {\n      function fetch() {\n        return _fetch.apply(this, arguments);\n      }\n\n      fetch.toString = function () {\n        return _fetch.toString();\n      };\n\n      return fetch;\n    }(function () {\n      fetch(\"\".concat(_constants__WEBPACK_IMPORTED_MODULE_0__[\"BASE_URL\"]).concat(this.channel, \"&sortBy=top\").concat(_constants__WEBPACK_IMPORTED_MODULE_0__[\"APIKEY\"]));\n    })\n  }]);\n\n  return Request;\n}();\n\nvar factory = new Factory();\nvar cnnChannel = factory.create('mtv-news');\nvar guardianChannel = factory.create('bbc-news');\nconsole.log('first mtv-news and bbc-news requests make factory pattern'); // structural\n// decorator\n\nvar Cake =\n/*#__PURE__*/\nfunction () {\n  function Cake() {\n    _classCallCheck(this, Cake);\n\n    this.price = 10;\n  }\n\n  _createClass(Cake, [{\n    key: \"getPrice\",\n    value: function getPrice() {\n      return this.price;\n    }\n  }]);\n\n  return Cake;\n}();\n\nvar CakeDecorator =\n/*#__PURE__*/\nfunction (_Cake) {\n  _inherits(CakeDecorator, _Cake);\n\n  function CakeDecorator(cake) {\n    var _this;\n\n    _classCallCheck(this, CakeDecorator);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(CakeDecorator).call(this));\n    _this.cake = cake;\n    return _this;\n  }\n\n  _createClass(CakeDecorator, [{\n    key: \"getPrice\",\n    value: function getPrice() {\n      return this.cake.getPrice() + 3;\n    }\n  }]);\n\n  return CakeDecorator;\n}(Cake);\n\nvar ChokoDecorator =\n/*#__PURE__*/\nfunction (_CakeDecorator) {\n  _inherits(ChokoDecorator, _CakeDecorator);\n\n  function ChokoDecorator(cake) {\n    _classCallCheck(this, ChokoDecorator);\n\n    return _possibleConstructorReturn(this, _getPrototypeOf(ChokoDecorator).call(this, cake));\n  }\n\n  _createClass(ChokoDecorator, [{\n    key: \"getPrice\",\n    value: function getPrice() {\n      return _get(_getPrototypeOf(ChokoDecorator.prototype), \"getPrice\", this).call(this) + 5;\n    }\n  }]);\n\n  return ChokoDecorator;\n}(CakeDecorator);\n\nvar cake = new Cake();\nvar decorateCake = new CakeDecorator(cake);\nvar decorateCakeWithChoko = new ChokoDecorator(decorateCake);\nconsole.log(decorateCakeWithChoko.getPrice(), 'decorateCakeWithChoko.getPrice()'); // behavioral\n// observer\n\nvar Star =\n/*#__PURE__*/\nfunction () {\n  function Star() {\n    _classCallCheck(this, Star);\n\n    this.fans = [];\n  }\n\n  _createClass(Star, [{\n    key: \"sendFoto\",\n    value: function sendFoto(photo) {\n      this.fans.forEach(function (fan) {\n        fan.notify(photo);\n      });\n    }\n  }, {\n    key: \"addFan\",\n    value: function addFan(fan) {\n      this.fans.push(fan);\n    }\n  }]);\n\n  return Star;\n}();\n\nvar Fan =\n/*#__PURE__*/\nfunction () {\n  function Fan(behavior) {\n    _classCallCheck(this, Fan);\n\n    this.behavior = behavior;\n  }\n\n  _createClass(Fan, [{\n    key: \"notify\",\n    value: function notify(photo) {\n      this.behavior(photo);\n    }\n  }]);\n\n  return Fan;\n}();\n\n;\nvar star = new Star();\nvar fan1 = new Fan(function () {\n  return console.log('WOW mountin');\n});\nvar fan2 = new Fan(function () {\n  return console.log('WOW!');\n});\nstar.addFan(fan1);\nstar.addFan(fan2);\nstar.sendFoto('I am on the mountin');\nconsole.log(star);\n\n//# sourceURL=webpack:///./src/js/patterns.js?");
