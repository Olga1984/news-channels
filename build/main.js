...
/*!***************************!*\
  !*** ./src/js/factory.js ***!
  \***************************/
/*! exports provided: NewsSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"NewsSource\", function() { return NewsSource; });\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ \"./src/js/constants.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar NewsSource =\n/*#__PURE__*/\nfunction () {\n  function NewsSource() {\n    _classCallCheck(this, NewsSource);\n  }\n\n  _createClass(NewsSource, [{\n    key: \"create\",\n    value: function create(channel) {\n      var requestType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'GET';\n\n      if (requestType === 'POST') {\n        var request = new RequestToChannel();\n        console.log('POST');\n        return request.fetch(channel, {\n          method: 'POST',\n          body: JSON.stringify({\n            name: 'vlad',\n            id: '1'\n          })\n        });\n      }\n\n      if (requestType === 'GET') {\n        var _request = new RequestToChannel();\n\n        console.log('GET');\n        return _request.fetch(channel);\n      }\n\n      if (requestType === 'PUT') {\n        var _request2 = new RequestToChannel();\n\n        console.log('PUT');\n        return _request2.fetch(channel, {\n          method: 'PUT',\n          body: JSON.stringify({\n            name: 'vlad',\n            id: '1'\n          })\n        });\n      }\n    }\n  }]);\n\n  return NewsSource;\n}();\n\nvar RequestToChannel =\n/*#__PURE__*/\nfunction () {\n  function RequestToChannel() {\n    _classCallCheck(this, RequestToChannel);\n  }\n\n  _createClass(RequestToChannel, [{\n    key: \"fetch\",\n    value: function (_fetch) {\n      function fetch(_x, _x2) {\n        return _fetch.apply(this, arguments);\n      }\n\n      fetch.toString = function () {\n        return _fetch.toString();\n      };\n\n      return fetch;\n    }(function (channel, requestMethod) {\n      var SOURCE_API = {\n        fetch: function (_fetch2) {\n          function fetch() {\n            return _fetch2.apply(this, arguments);\n          }\n\n          fetch.toString = function () {\n            return _fetch2.toString();\n          };\n\n          return fetch;\n        }(function () {\n          var url = \"\".concat(_constants__WEBPACK_IMPORTED_MODULE_0__[\"BASE_URL\"]).concat(channel, \"&sortBy=top\").concat(_constants__WEBPACK_IMPORTED_MODULE_0__[\"APIKEY\"]);\n          return fetch(url, requestMethod).then(function (response) {\n            return response.json();\n          });\n        })\n      };\n      return SOURCE_API;\n    })\n  }]);\n\n  return RequestToChannel;\n}();\n\n//# sourceURL=webpack:///./src/js/factory.js?");
